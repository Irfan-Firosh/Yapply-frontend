...
const AdminDashboard = () => {
  ...
  const refreshData = useCallback(async () => {
    ...
    try {
      await Promise.all([
        ...
        fetchRolesData(), // roles don't need force refresh
      ]);
      toast({
  ...
  const getStatusBadge = (status: string) => {
    ...
    switch (normalizedStatus) {
      ...
      default:
        return (
          <span className='status-pending'>{capitalizeFirst(status)}</span>
        );
    }
  };
  ...
  const fetchRolesData = async () => {
    ...
    try {
      ...
      // Don't show toast for roles as it's not critical
    }
  };
        ...
        <div className='flex items-center justify-between mb-8 animate-fade-in'>
          <div>
            <h1 className='text-3xl font-bold tracking-tight'>
              {capitalizeFirst(company.username)} Portal
            </h1>
            ...
            {interviewsLoading ? (
              ...
              <div className='p-8 text-center'>
                <p className='text-muted-foreground'>
                  No interviews found. Schedule your first interview to get
                  started!
                </p>
              </div>
            ) : (
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  ...
                                  permanently remove all interview data.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
